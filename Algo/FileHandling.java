...
public class FileHandling {
    public static void main(String[] args) {
        ...
        //     // File myFile = new File("/Users/kashif/Documents/Example.txt"); // To use when
        //     // create a file in a specific folder
        //     if (myFile.createNewFile()) { // Try to create file
        //         System.out.println("File created: " + myFile.getName()); // Print the name of file
        //     } else {
        ...
        //     myFile.close(); // Must close the FileWriter manually with this method of code
